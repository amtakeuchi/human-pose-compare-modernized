...
import numpy 
import numpy as np
from pose_simple import PoseSimple
from score import Score
import pickle
import argparse

# USAGE : python3 keypoints_from_video_simple.py --activity "punch - side" --video "test.mp4" 
...
def main():
    ...
    while cap.isOpened():
        ...
        if ret_val:
            ...
            cv2.imshow("Pose Detection", input_black_image)
