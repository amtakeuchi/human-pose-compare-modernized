...
import numpy 
import numpy as np
from pose_enhanced import PoseEnhanced
from score import Score
import pickle
import argparse

# USAGE : python3 keypoints_from_video_enhanced.py --activity "punch - side" --video "test.mp4" 
...
def main():
    ...
    while cap.isOpened():
        ...
        if ret_val:
            ...
            cv2.imshow("Enhanced Pose Detection", input_black_image)
    ...
    print("Enhanced Lookup Table Created")
    c[args["activity"]] = b
